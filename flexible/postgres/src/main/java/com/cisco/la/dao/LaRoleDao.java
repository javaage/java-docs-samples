...
public interface LaRoleDao{
	 ...
	 * @return
	 */
    int updateLaRole(@Param("enti") LaRole value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyLaRole(@Param("enti") LaRole value, @Param("assist") Assist assist);
}