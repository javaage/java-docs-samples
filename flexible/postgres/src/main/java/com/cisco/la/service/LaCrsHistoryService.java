...
public interface LaCrsHistoryService{
	/**
	 ...
	 * @return
	 */
    int updateLaCrsHistory(LaCrsHistory value,  Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyLaCrsHistory(LaCrsHistory value, Assist assist);
}