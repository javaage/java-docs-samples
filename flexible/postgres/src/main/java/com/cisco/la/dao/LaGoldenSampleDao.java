...
public interface LaGoldenSampleDao{
	/**
	...
	/**
	 * 批量插入LaGoldenSample到数据库,包括null值
	 * @param value
	 * @return
	 */
	 ...
	 * @return
	 */
    int updateLaGoldenSample(@Param("enti") LaGoldenSample value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyLaGoldenSample(@Param("enti") LaGoldenSample value, @Param("assist") Assist assist);
}