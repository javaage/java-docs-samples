...
public interface LaCourseDao{
	 ...
	 * @return
	 */
    int updateLaCourse(@Param("enti") LaCourse value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptyLaCourse(@Param("enti") LaCourse value, @Param("assist") Assist assist);
}